...
updated: 2026-07-12
confidence: high
tags: [queueable-action, spatie, architecture, laraxot, job]
related:
  - Modules/Xot/docs/queueable-actions.md
---

# Queueable Actions — Job Module Doctrine
...
```bash
cd laravel
php -d memory_limit=2048M vendor/bin/phpstan analyse Modules/Job --no-progress
vendor/bin/pint Modules/Job/app/Actions
```
