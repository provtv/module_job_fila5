...
| Ricerca locale | `qmd search "topic" -c job` |
| Wiki locale | `Read ./laravel/Modules/Job/docs/wiki/index.md` |
...
3. **Mantieni la wiki aggiornata** — Dopo ogni task, aggiorna ./laravel/Modules/Job/docs/wiki/log.md
