...
created: 2026-05-04
updated: 2026-05-04
tags: [visual-testing, playwright, puppeteer, e2e, screenshot, laravel, Job]
related:
  - playwright-testing-policy
---

# Visual Testing con Playwright e Puppeteer — Modulo Job
...
I test Playwright del modulo Job appartengono a:

```
laravel/Modules/Job/tests/Playwright/
```
...
```javascript
// laravel/Modules/Job/tests/Playwright/visual-regression.spec.js
import { test, expect } from '@playwright/test';

test('Job UI renders correctly', async ({ page }) => {
    await page.goto('/it/...');
    await page.waitForLoadState('networkidle');
    await expect(page).toHaveScreenshot('Job-initial.png', {
