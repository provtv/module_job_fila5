...
type: concept
module: Job
tags: [job, filament, xotbase, architecture]
created: 2026-07-16
updated: 2026-07-16
qmd: "Job filament never extend Filament class XotBase mirror path"
related:
...
Nessuna classe in `Modules/Job` estende una classe `Filament\...` direttamente.
